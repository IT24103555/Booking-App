      ...
      <ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
        <View style={styles.heroCard}>
          ...
          <View style={styles.heroOverlay}>
            ...
            <Text style={styles.subtitle}>Create a polished venue profile with capacity, location, and availability.</Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <AppInput label="Name" value={name} onChangeText={setName} placeholder="Auditorium A" />
          <AppInput label="Location" value={location} onChangeText={setLocation} placeholder="Main campus, Building 2" />
          <AppInput label="Capacity" value={capacity} onChangeText={setCapacity} placeholder="200" keyboardType="numeric" />
          <AppInput label="Description" value={description} onChangeText={setDescription} placeholder="Short venue description" />
          ...
          <View style={styles.actions}><AppButton title={saving ? 'Saving...' : 'Create Venue'} onPress={onSave} disabled={saving} /></View>
        </View>
      </ScrollView>
