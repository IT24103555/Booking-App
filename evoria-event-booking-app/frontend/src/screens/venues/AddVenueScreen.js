    ...
    >
      <ScrollView contentContainerStyle={styles.page} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Create a polished venue profile with capacity, location, media, and availability.</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.actions}>
            <AppButton title={saving ? 'Saving...' : 'Create Venue'} onPress={onSave} disabled={saving} />
          </View>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
